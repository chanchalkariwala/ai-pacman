...
def uniformCostSearch(problem):
    ...
    while (problem.isGoalState(currentPosition) == False):
        ...
        for child in children:
            ...
            list_node_cost = []
            list_node_cost.append(child)
            list_node_cost.append(cost)

            fringe.update(list_node_cost, cost)
            relations[currentPosition].append(child[0])

        while (True):
            poppedItem = fringe.pop()
            currentPosition = poppedItem[0][0];
            cost_to_currentPosition = poppedItem[1]
            if currentPosition not in visited:
                directions[currentPosition] = poppedItem[0][1]
                break;
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while (problem.isGoalState(currentPosition) == False):
        ...
        for child in children:
            heuristics[child[0]] = heuristic(child[0], problem)
            cost = cost_to_currentPosition + child[2] + heuristics[child[0]]
        ...
        while (True):
            poppedItem = fringe.pop()
            currentPosition = poppedItem[0][0];
            cost_to_currentPosition = poppedItem[1] - heuristics[poppedItem[0][0]]
